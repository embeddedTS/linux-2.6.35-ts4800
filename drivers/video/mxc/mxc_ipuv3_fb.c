...
//Added by TS RONALD
static char *mode_param = "800x480M-16";
module_param(mode_param, charp, 0000);
MODULE_PARM_DESC(mode_param, "Video mode for mxcfb driver, e.g. mxcfb:800x480M");
...
//RONALD: ADDED MODULE SUPPORT 
#ifndef MODULE
	if (options)
                mxcfb_option_setup(fbi, options);
#else
        mxcfb_option_setup(fbi, mode_param);
#endif
