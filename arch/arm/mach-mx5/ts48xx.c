...
#define TS48XX_EN_USB_5V		(0*32 + 9)      /* GPIO_1_9 */
...
/*RONALD added for TS-4800 RTC support */
        {
         .type = "m41t00",
         .addr = 0x68,
         },
...
static void __init mx51_babbage_io_init(void)
{
	...
	*/
	...
	/* TS-4800 Enable USB 5V */
	gpio_request(TS48XX_EN_USB_5V, "en-usb-5v");
        gpio_direction_output(TS48XX_EN_USB_5V, 1);
        msleep(10);
        gpio_set_value(TS48XX_EN_USB_5V, 1);
}
