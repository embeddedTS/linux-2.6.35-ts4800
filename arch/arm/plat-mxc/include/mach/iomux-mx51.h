...
/* CSPI */ //RONALD
#define MX51_PAD_CSPI1_SCLK__CSPI1_SCLK         IOMUX_PAD(0x614, 0x224, 0, 0x0, 0, MX51_PAD_CTRL_11)
#define MX51_PAD_CSPI1_MISO__CSPI1_MISO         IOMUX_PAD(0x604, 0x214, 0, 0x0, 0, MX51_PAD_CTRL_11)
#define MX51_PAD_CSPI1_MOSI__CSPI1_MOSI         IOMUX_PAD(0x600, 0x210, 0, 0x0, 0, MX51_PAD_CTRL_11)
...
/* RONALD: TS-48XX UART3 */
#define MX51_PAD_UART3_RXD__UART3_RXD   IOMUX_PAD(0x630, 0x240, IOMUX_CONFIG_ALT1, 0x9f4, 4, MX51_UART3_PAD_CTRL)
#define MX51_PAD_UART3_TXD__UART3_TXD   IOMUX_PAD(0x634, 0x244, IOMUX_CONFIG_ALT1, 0x0, 0, MX51_UART3_PAD_CTRL)
...
/*RONALD: TS-4800 FEC IOMUX CONFIG*/
#define MX51_PAD_DISP2_DAT10__FEC_COL    IOMUX_PAD(0x784, 0x37C, 2, 0x94c, 0x1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT11__FEC_RXCLK  IOMUX_PAD(0x788, 0x380, 2, 0x968, 0x1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT14__FEC_RDAT0  IOMUX_PAD(0x794, 0x38C, 2, 0x958, 0x1, MX51_PAD_CTRL_4)
...
#define MX51_PAD_DISP2_DAT13__FEC_TX_CLK IOMUX_PAD(0x790, 0x388, 2, 0x974, 0x1, MX51_PAD_CTRL_4)
#define MX51_PAD_DISP2_DAT12__FEC_RX_DV  IOMUX_PAD(0x78C, 0x384, 2, 0x96c, 0x1, MX51_PAD_CTRL_4)
